...
using ShippingTracking.APIs.Errors;
using ShippingTracking.APIs.Extensions;
...
{
    protected readonly ShippingTrackingDbContext _context;

    public CustomersServiceBase(ShippingTrackingDbContext context)
    {
        _context = context;
    }
