...
@InputType()
class ProcessorLogCreateNestedManyWithoutMessageQueuesInput {
...
export { ProcessorLogCreateNestedManyWithoutMessageQueuesInput as ProcessorLogCreateNestedManyWithoutMessageQueuesInput };
