...
export class FlightServiceBase {
  ...
  async getAirline(parentId: string): Promise<PrismaAirline | null> {
  ...
  async getArrivalAirport(parentId: string): Promise<PrismaAirline | null> {
    return this.prisma.flight
      .findUnique({
        where: { id: parentId },
      })
  ...
  async getDepartureAirport(parentId: string): Promise<PrismaAirport | null> {
    return this.prisma.flight
      .findUnique({
        where: { id: parentId },
      })
